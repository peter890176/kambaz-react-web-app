import {
  ...
  require_prop_types,
  require_warning
} from "./chunk-77PLFKBZ.js";
import {
  require_react_dom
} from "./chunk-P4VTV5VF.js";
import {
  FormRange_default
} from "./chunk-43HHUMAY.js";
import {
  DEFAULT_BREAKPOINTS,
...
var FormSelect = React75.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var Switch = React77.forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React78.forwardRef(({
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime71.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames54.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime70.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Form = React79.forwardRef(({
  ...
  as: Component2 = "form",
  ...props
}, ref) => (0, import_jsx_runtime72.jsx)(Component2, {
  ...props,
  ref,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime74.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime74.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime74.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime74.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React81.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
...
function useMergedRefs2(refA, refB) {
  return (0, import_react59.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react60.useContext)(SelectableContext_default);
  const navContext = (0, import_react60.useContext)(NavContext_default);
  const tabContext = (0, import_react60.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
var NavItem = React83.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime75.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React84.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react61.useRef)(false);
  ...
  const listNode = (0, import_react61.useRef)(null);
  ...
  return (0, import_jsx_runtime76.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime76.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime76.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
function useCallbackRef2() {
  return (0, import_react62.useState)(null);
}
...
function useWillUnmount2(fn2) {
  ...
  (0, import_react64.useEffect)(() => () => onUnmount.current(), []);
}
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react65.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react66.useRef)(inProp);
  ...
  const child = (0, import_react66.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react67.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react67.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react67.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react67.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react67.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react67.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react67.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react67.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React87.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime79.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react68.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react68.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime80.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime80.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime80.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react69.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react69.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react69.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react69.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime81.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react69.useState)(!show);
  const lastFocusRef = (0, import_react69.useRef)(null);
  (0, import_react69.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react69.useRef)();
  const removeKeydownListenerRef = (0, import_react69.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime81.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, {
...
var AbstractModalHeader = React94.forwardRef(({
  ...
  const context6 = (0, import_react70.useContext)(ModalContext_default);
...
var Modal2 = React97.forwardRef(({
  ...
  const renderBackdrop = (0, import_react71.useCallback)((backdropProps) => (0, import_jsx_runtime89.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime89.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime89.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime89.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var Nav2 = React100.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime92.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarCollapse = React102.forwardRef(({
  ...
  return (0, import_jsx_runtime94.jsx)(Collapse_default, {
...
var NavbarToggle = React103.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime95.jsx)("span", {
...
var OffcanvasToggling = React105.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasHeader = React106.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime100.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime100.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React108.forwardRef(({
  ...
  const renderBackdrop = (0, import_react77.useCallback)((backdropProps) => (0, import_jsx_runtime100.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames75.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime100.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime102.jsxs)(import_jsx_runtime101.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime100.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime100.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React109.forwardRef(({
  onHide,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime103.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React111.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime105.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React112.forwardRef(({
  ...
  return (0, import_jsx_runtime107.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames78.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime106.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var Popover = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsxs)("div", {
    ...
    className: (0, import_classnames81.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime110.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime110.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React118.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames82.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime112.jsx)("div", {
      className: "tooltip-arrow",
      ...arrowProps
    }), (0, import_jsx_runtime112.jsx)("div", {
...
var Overlay2 = React119.forwardRef(({
  ...
  return (0, import_jsx_runtime114.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React119.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames83.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime117.jsxs)(import_jsx_runtime116.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react84.cloneElement)(children, triggerProps), (0, import_jsx_runtime115.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React121.forwardRef(({
  ...
  return (0, import_jsx_runtime118.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames84.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime119.jsxs)(Component2, {
      className: (0, import_classnames84.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime118.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React121.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime119.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React122.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames85.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames86.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React123.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime121.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime123.jsx)("div", {
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime123.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
