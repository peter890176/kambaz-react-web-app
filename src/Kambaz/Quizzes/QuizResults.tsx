...
import { Container, Card, Alert, Button, ProgressBar, Badge, Table, Modal } from 'react-bootstrap';
import { FaArrowRight, FaCheckCircle, FaTimesCircle, FaClock, FaCalendarAlt, FaArrowLeft } from 'react-icons/fa';
