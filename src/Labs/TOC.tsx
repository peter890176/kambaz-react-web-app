...
export default function TOC() {
    ...
    return (
        <ul className="nav nav-pills" id="wd-toc">
            ...
            <li className="nav-item"><a id="wd-github" href="https://github.com/peter890176/kambaz-react-web-app" target="_blank"
                className="nav-link">My GitHub Frontend</a></li>
            <li className="nav-item"><a id="wd-github" href="https://github.com/peter890176/kambaz-node-server-app" target="_blank"
                className="nav-link">My GitHub Backend</a></li>
            <li className="nav-item"><a id="wd-github" href="https://kambaz-node-server-app-uhkc.onrender.com" target="_blank"
                className="nav-link">Backend Server</a></li>
